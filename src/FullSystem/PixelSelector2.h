...
class PixelSelector
{
 public:
  ...
  /// The potential of currently selecting pixels is the size of the grid.
 ...
 private:
  ...
  /// Histogram of square root and square gradient distribution, 0 is the number of all pixels
  int* gradHist;
