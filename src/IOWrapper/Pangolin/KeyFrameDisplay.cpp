...
bool KeyFrameDisplay::refreshPC(bool canRefresh, float scaledTH, float absTH, int mode, float minBS, int sparsity)
{
  ...
  // std::cout << "tmpVertexBuffer: " << tmpVertexBuffer->transpose() << std::endl;
  // std::cout << "tmpColorBuffer: " << tmpColorBuffer->transpose() << std::endl;
...
void KeyFrameDisplay::drawPC(float pointSize) {
  if(!bufferValid || numGLBufferGoodPoints==0) {
    // std::cout << "[-] bufferValid: " << bufferValid << std::endl;
    // std::cout << "[-] numGLBufferGoodPoints: " << numGLBufferGoodPoints << std::endl;
    return;
  }
  // std::cout << "[+] bufferValid: " << bufferValid << std::endl;
  // std::cout << "[+] numGLBufferGoodPoints: " << numGLBufferGoodPoints << std::endl;
