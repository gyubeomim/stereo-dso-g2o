...
class FrameShell {
 public:
  ...
  /// ? what's the difference b/w the two IDs?
  ...
  int marginalizedAt;              /// id of the latest keyframe when marginalized
  double movedByOpt;               /// 6dof module of distance linearized point pose obtained during marginalization
